...
public class AsrProviderConfiguration {
    ...
    public AsrProvider asrProvider(
        ...
        return switch (properties.provider()) {
            ...
            case "groq" -> groqProvider(properties, validator);
            case "dashscope" -> dashScopeProvider(properties, validator);
    ...
    private AsrProvider groqProvider(
        ...
        return new GroqAsrProvider(properties, validator);
    }
    ...
    private AsrProvider dashScopeProvider(
        ...
        return new DashScopeAsrProvider(properties, validator);
    }
}
