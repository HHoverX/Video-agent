...
public enum ErrorCode {
    ...
    UPLOAD_SESSION_NOT_FOUND(HttpStatus.NOT_FOUND, "上传会话不存在"),
    UPLOAD_SESSION_EXPIRED(HttpStatus.GONE, "上传会话已过期"),
    UPLOAD_SESSION_STATE_CONFLICT(HttpStatus.CONFLICT, "上传会话状态不允许当前操作"),
    ...
    ANALYSIS_RETRY_EXHAUSTED(HttpStatus.INTERNAL_SERVER_ERROR, "分析任务重试投递耗尽"),
    ANALYSIS_VIDEO_TOO_LONG(HttpStatus.UNPROCESSABLE_ENTITY, "视频时长超过当前 AI 分析支持范围"),
    INTERNAL_ANALYSIS_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "分析任务内部错误"),
    ...
    ASR_PROVIDER_REJECTED(HttpStatus.UNPROCESSABLE_ENTITY, "语音转写服务拒绝了请求"),
    ...
    LLM_PROVIDER_REJECTED(HttpStatus.UNPROCESSABLE_ENTITY, "LLM 服务拒绝了请求"),
    LLM_SUMMARY_INVALID(HttpStatus.UNPROCESSABLE_ENTITY, "LLM 总结结果不合法"),
    SUMMARY_INPUT_TOO_LARGE(HttpStatus.UNPROCESSABLE_ENTITY, "视频字幕内容超过当前 AI 总结支持范围"),
    ...
    EMBEDDING_PROVIDER_REJECTED(HttpStatus.UNPROCESSABLE_ENTITY, "Embedding 服务拒绝了请求"),
    EMBEDDING_RESPONSE_INVALID(HttpStatus.UNPROCESSABLE_ENTITY, "Embedding 服务返回无效结果"),
